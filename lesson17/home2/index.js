/* Вызов ф-ции с помощью apply
С помощью ф-ции apply можно вызывать ф-цию с заданным контекстом. А так же дополнительно можно передавать в ф-цию аргументы в виде массива (func.apply(context, [arg1, arg2, ...]))

Основные требования:
Начальный код находится в редакторе ниже
Используйте метод .apply для вызова ф-ции в каждом задании
...
const populationInUkraine = getPopulation.apply(country, [43000]);
console.log(populationInUkraine);
