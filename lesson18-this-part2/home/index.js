...
Функция saveCalls должна принимать функцию как единсвернный параметр, 
и вернуть функцию, которая будет запоминать все свои вызовы входящей функции в свойстве calls. 
Каждый вызов храниться как массив аргументов.
